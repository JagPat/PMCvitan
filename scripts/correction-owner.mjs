...
function undeclaredInstruction(declaration) {
  // A HEAD-bound ownership inconsistency (the editable body marker vs. the immutable commit
  // trailer) is unroutable: no wake is addressed to the body owner, because the body is the
  // half that may be lying. The remedy names which side to fix.
