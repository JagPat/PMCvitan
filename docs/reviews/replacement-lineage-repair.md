...
**This unit replaces #392, and it discharges nothing else.** It does **not**
...
each did the same; this unit replaces #392. Each closure **at the round limit**
...
Twenty finding-bearing heads across ten units bought the table and its
consequences — #383 through #392, every one of them at two apiece — which is the
...
this document's own lineage is the demonstration: #383 through #392 each closed at
the round limit and each added one obligation as it closed — ten units, ten
...
- **Pending: #377, #378, #379, #383, #384, #385, #386, #387, #388, #389, #390, #391
  and #392. Settled: #381, by merged #382** — which still carries the label, because
  discharge is computed rather than un-marked. **#391 and #392 are both in this set**:
  each closed at the round limit while claiming its predecessor, so the claim lapsed
  with the claimant and source and claimant are both owed. This unit replaces #392 and
