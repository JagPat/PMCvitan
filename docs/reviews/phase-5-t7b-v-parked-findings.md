...
This branch is `46464da` — the exact head Codex reviewed. It carries the
`certifier-may-not-approve` grant surface **complete and unfixed**, so nothing known-broken shipped
in PR #317 and nothing has to be reconstructed from memory later.
