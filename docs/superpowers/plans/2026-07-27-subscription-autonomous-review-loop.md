...
- [x] **Step 1: Write fixture tests for clean, findings, stale evidence, timeout, and precedence**
- [x] **Step 2: Run `node --test scripts/autonomous-review-state.test.mjs` and verify RED**
- [x] **Step 3: Implement the minimal pure classifier and eligibility predicate**
- [x] **Step 4: Run the focused tests and verify GREEN**
- [x] **Step 5: Add `test:automation` and include it in root `pnpm check`**
...
- [x] **Step 1: Write workflow/source contract tests that fail against the old existence-only merge gate**
- [x] **Step 2: Run `node --test scripts/autonomous-review-workflow.test.mjs` and verify RED**
- [x] **Step 3: Implement API helpers, CI aggregation, sticky comments, bounded polling, and draft/ready transitions**
- [x] **Step 4: Replace the workflow with trusted `workflow_run` and `workflow_dispatch` orchestration**
- [x] **Step 5: Add automation tests to the existing `web` CI job and run focused tests GREEN**
...
- [x] **Step 1: Replace the impossible “Codex reviews drafts” rule with CI→ready→review**
- [x] **Step 2: Require Claude cloud Auto-fix subscription until terminal PR state**
- [x] **Step 3: Document fail-closed recovery and the exact branch-protection settings**
- [x] **Step 4: Record base/head, tests, external setting changes, and PR #230 bootstrap steps**
...
- [x] **Step 1: Run `pnpm test:automation`**
- [x] **Step 2: Run `pnpm check`**
- [x] **Step 3: Run workflow YAML and credential scans**
