...
4d PLAN unit only"), one PR at a time, from `main` `d7eed4ce` — first as #537, then #538, then #539, then #540, then #541, then #542, now as the
sixth replacement (below).
...
#535, #537, #538, #539, #540, #541 and #542 did). `reviewed_merge` stays `f5da6654` (the last REVIEWED merge; #536 was a STATUS
...
**Lineage: #537, #538, #539, #540, #541 and #542 each closed at the review-round limit; this PR replaces #542 and settles its ledger obligation.**
...
(`a05fdd80`, `6ec40f12`: three + four) and #542 (`aafc0e17`, `182a09bf`: five + three) each drew
...
see the pending decision the plan lets them forward. This PR carries all sixty-two fixes with `Replaces: #542`,
the three annotated "(review round 12)" in the plan where they land. **The ledger, read off the label** (the
#514/#513 lesson): the obligation is the repository-wide `review-replacement-required` LABEL, not the prose
lineage. #542 was labelled by the orchestrator BEFORE it closed, so it is the obligation this PR settles. #541
was NOT — it was closed and its branch rebuilt before the orchestrator's gate could label it, so its gate run
found itself superseded, the scope gate refused #542's `Replaces: #541`, and #542 declared `Replaces: #540`
instead; #540's obligation is therefore ORPHANED by that sequencing error and stays pending on the ledger
