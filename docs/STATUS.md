...
**UNIT 4c-iii IS OPEN AS PR #505 (branch `claude/phase6-4c-iii-enablement-2`) AND IS HELD.** It is
...
PR #505 REPLACES #503, which reached the two-finding-bearing-head review-round limit and was
closed unmerged per the review protocol — not because the unit was wrong. #503's second review
