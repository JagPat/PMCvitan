...
4d PLAN unit only"), one PR at a time, from `main` `d7eed4ce` — first as #537, then #538, then #539, then #540, then #541, now as the
fifth replacement (below).
...
#535, #537, #538, #539, #540 and #541 did). `reviewed_merge` stays `f5da6654` (the last REVIEWED merge; #536 was a STATUS
