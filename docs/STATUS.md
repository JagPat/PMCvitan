...
| 6B | §F status derivation over three folds + payment reversals | in_progress — the FIRST unit is root A's mechanical closure (`CLOSURE 10`), shipped AHEAD of the substance it polices, because a closure that lands beside its own work cannot have caught anything in that work |
