...
describe('Phase 4 Task 2 — labour commercial chain (live PG)', () => {
  ...
  const RESET_TABLES = ['VendorAdvance', 'PaymentReversal', 'Payment', 'PaymentApproval',
    ...
    'CashForecastProjection', 'LabourReadinessProjection', 'CapacityPromise',
    ...
    'VendorLabourProfile', 'ProjectPartyVendorSource', 'ProjectPartyCompanySource',
    'ProjectParty', 'ProjectVendor', 'CommandExecution', 'CrewMembership', 'Crew',
