...
const INVENTORY: Record<string, string[]> = {
  ChangeRequest: ['ChangeRequest_t4d_birth_pair', 'ChangeRequest_t4d_evidence_frozen',
    'ChangeRequest_t4d_no_truncate', 'ChangeRequest_t4d_project', 'ChangeRequest_t4d_source_bound'],
  Decision: [
